...
local function Init()
    ...
    local function CreatePlayerESP()
        ...
        cache.BoxFill = CreateDrawing("Square", {
            ...
            Color = Color3.fromRGB(0, 0, 0), Transparency = 0.85,
        })
        cache.Name = CreateDrawing("Text", {
            Size = Settings.FontSize, Center = true, Outline = true,
            Visible = false, Color = Color3.fromRGB(255, 255, 255), Font = 2,
        })
